...
- **Stick_FRig V15** — in-engine **`STICKMAN_BASE_GLTF_URL`**: `source_assets/Stick_FRig_V15.blend` → `scripts/blender/export_stick_frig_hero_glb.py` → `public/models/stick_frig_v15_hero.glb`. Project-owned rig + mesh.
